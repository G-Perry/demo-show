...
凭聊天我好像没本事提高太多好感，还是要多见面才行。（我真正聊了的也就你、第四、第六位，
我发现过了初期探索那段过程之后，找不到话题聊天很无趣，自然也约不出来，异地而处，我也不
想浪费大半天的时间，跟一个无趣的人出去。第六位一开始也没出来，约了第三次还是第四次才见
面的，见面之后聊起来感觉好点了，也可能是错觉，后面我再总结总结）
...
答：10月-12月中旬：你是我天赐的缘分。（已废弃）
    ...
    过来。从你这获取经验是因，之后运用在第六位以及今后其他人的实践中，便是果。很感谢你在
    阶段三四那会儿对我无礼行为的包容，容我再次向你诚挚地致歉。（上文我提到，如果阶段三末
    期你能与我讨论复盘一番，我大概就不会想第二个意义了，直接就能得出类似于“你是我相亲路
    上的经验包”的结论，也就不会有后面的事了。）
...
祝君早觅良人，寻得一个好人家，带着我的祝福一定要幸福快乐呀。
（二三月我说不出这个话，四月只能说后两句。写到这里，我忽然想起来你四月那会
儿换了个那种花开富贵的头像，我还想找你来着，还好忍住了哈哈哈哈哈，后来看你
又换回来了，想来是度过了烦心事，真好）
