...
export default {
  ...
  mounted() {
    ...
    var mouseX = 0,
      mouseY = 0;
    var windowHalfX = parent.offsetWidth / 2;
    var windowHalfY = parent.offsetHeight / 2;
    ...
    uniform vec3 color;
      ...
      renderer.setSize(parent.offsetWidth, parent.offsetHeight >> 1);
    ...
    function onWindowResize() {
      ...
      windowHalfX = parent.offsetWidth / 2;
      windowHalfY = parent.offsetHeight / 2;
