<template>
  <div ref="son_fit_father" id="son_fit_father" class="son_fit_father" style="position: relative;">
    <!-- 
...
export default {
  ...
  mounted() {
    const container = document.getElementById("son_fit_father");
    ...
    this.$refs.three_demo.appendChild(stats.domElement);
